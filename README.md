...
references/          backbone: constitution · artifact-model · specification-bar · authoring-procedure · stage-contract · grilling-engine · diagrams
skills/<name>/       One folder per skill — doors, critics, and authoring stages: SKILL.md (+ references/, scripts/)
skills/spec/references/  workflow.md (flow program) · rubrics/ (cascade only)
```
